...
INSERT INTO `bookings` (`booking_id`, `user_id`, `merchant_id`, `service_id`, `transaction_id`, `booking_date`, `timeslot`, `status`, `qr_code_token`) VALUES (1,1,3,6,NULL,'2026-05-02 00:00:00','10:00:00','pending','3.5hZQkaBOvB5EqhMqFhjMmmgtu7kBIU54hGN4DsJNzDo'),(2,1,1,1,NULL,'2026-05-04 00:00:00','10:00:00','pending','1.5DrcsaqSGQOxXceqYQMKib_AVegXgVwcxYjABvNy658'),(3,1,1,2,NULL,'2026-05-04 00:00:00','11:00:00','pending','1.5DrcsaqSGQOxXceqYQMKib_AVegXgVwcxYjABvNy658'),(4,1,1,2,NULL,'2026-05-03 00:00:00','11:00:00','pending','1.5DrcsaqSGQOxXceqYQMKib_AVegXgVwcxYjABvNy658'),(5,1,1,2,NULL,'2026-05-18 00:00:00','15:30:00','pending','1.5DrcsaqSGQOxXceqYQMKib_AVegXgVwcxYjABvNy658'),(6,6,1,1,NULL,'2026-05-27 00:00:00','14:00:00','pending','vaniday-beauty-studio-orchard');
...
INSERT INTO `categories` (`category_id`, `category_name`, `icon_url`) VALUES (1,'Hair',NULL),(2,'Facial',NULL),(3,'Nails',NULL),(4,'Massage',NULL),(5,'Barber',NULL);
...
INSERT INTO `daily_reward_settings` (`day_number`, `points`, `updated_at`) VALUES (1,10,'2026-05-06 02:29:02'),(2,10,'2026-05-06 02:29:02'),(3,20,'2026-05-06 02:29:02'),(4,20,'2026-05-06 02:29:02'),(5,30,'2026-05-06 02:29:02'),(6,50,'2026-05-06 02:29:02'),(7,100,'2026-05-06 02:29:02');
...
INSERT INTO `daily_reward_wallets` (`reward_wallet_id`, `user_id`, `cycle_start_date`, `current_day`, `last_claim_date`, `created_at`, `updated_at`) VALUES (1,1,'2026-05-06 00:00:00',2,'2026-05-06 00:00:00','2026-05-02 03:30:41','2026-05-06 01:31:56'),(7,6,'2026-05-02 00:00:00',0,NULL,'2026-05-02 16:28:33','2026-05-02 16:28:33'),(8,7,'2026-05-03 00:00:00',0,NULL,'2026-05-03 12:13:36','2026-05-03 12:13:36');
...
INSERT INTO `game_plays` (`play_id`, `user_id`, `prize_id`, `prize_title`, `prize_type`, `reward_value`, `created_at`) VALUES (1,1,1,'60 VaniGlints','glints',60,'2026-05-02 03:01:08'),(2,7,3,'Priority Booking Perk','benefit',NULL,'2026-05-03 12:20:14');
...
INSERT INTO `game_settings` (`setting_id`, `weekly_free_plays`, `spend_per_bonus_play`, `bonus_plays_per_threshold`, `is_enabled`, `updated_at`) VALUES (1,1,'80.00',1,1,'2026-05-01 13:37:55');
...
INSERT INTO `game_wallets` (`user_id`, `play_balance`, `last_weekly_grant`, `bonus_milestones_granted`, `updated_at`) VALUES (1,7,'2026-05-01 00:00:00',5,'2026-05-06 01:36:47'),(7,0,'2026-04-23 00:00:00',0,'2026-05-03 12:20:19');
...
INSERT INTO `loyalty_rules` (`rule_id`, `points_per_dollar`, `cashback_percent`, `min_points_to_redeem`, `points_to_cash_rate`, `is_enabled`, `updated_at`) VALUES (1,'10.00','5.00',100,'0.0100',1,'2026-05-01 18:47:04');
...
INSERT INTO `loyalty_transactions` (`loyalty_transaction_id`, `user_id`, `source_receipt_id`, `transaction_type`, `points_delta`, `cashback_delta`, `description`, `created_at`) VALUES (1,1,'order-6','earn',280,'1.40','Earned from receipt 6','2026-05-03 11:49:33'),(2,1,'order-5','earn',280,'1.40','Earned from receipt 5','2026-05-03 11:49:33'),(29,1,'order-11','earn',320,'1.60','Earned from receipt 11','2026-05-03 12:00:56');
...
INSERT INTO `loyalty_wallets` (`user_id`, `points_balance`, `cashback_balance`, `lifetime_points`, `updated_at`) VALUES (1,880,'4.40',880,'2026-05-03 12:00:56'),(7,0,'0.00',0,'2026-05-03 12:13:36');
...
INSERT INTO `promotion_redemptions` (`redemption_id`, `promotion_id`, `user_id`, `booking_id`, `redeemed_at`, `status`) VALUES (1,1,1,2,'2026-05-02 01:24:54','used'),(2,22,1,3,'2026-05-02 01:44:24','used'),(3,2,1,4,'2026-05-02 01:44:41','used'),(4,22,1,5,'2026-05-02 01:48:11','used');
...
INSERT INTO `purchase_history` (`history_id`, `receipt_id`, `user_id`, `purchase_type`, `item_names`, `items_json`, `total_amount`, `payment_method`, `payment_status`, `delivery_status`, `refund_status`, `refunded_amount`, `refunded_at`, `created_at`) VALUES (1,'order-5',1,'product','Calming Body Oil','[{\"name\":\"Calming Body Oil\",\"type\":\"Product\",\"price\":28,\"detail\":\"Bodycare\",\"quantity\":1,\"lineTotal\":28,\"serviceId\":\"body-oil\",\"unitPrice\":28}]','28.00','Card payment','paid','processing','none','0.00',NULL,'2026-05-01 18:35:55'),(3,'order-6',1,'product','Calming Body Oil','[{\"name\":\"Calming Body Oil\",\"type\":\"Product\",\"price\":28,\"detail\":\"Bodycare\",\"quantity\":1,\"lineTotal\":28,\"serviceId\":\"body-oil\",\"unitPrice\":28}]','28.00','Card payment','paid','processing','none','0.00',NULL,'2026-05-01 18:49:39'),(4,'order-11',1,'product','Repair Hair Mask','[{\"name\":\"Repair Hair Mask\",\"type\":\"Product\",\"price\":32,\"detail\":\"Haircare\",\"quantity\":1,\"lineTotal\":32,\"serviceId\":\"hair-mask\",\"unitPrice\":32}]','32.00','Card payment','paid','processing','none','0.00',NULL,'2026-05-03 12:00:55');
...
INSERT INTO `salons` (`salon_id`, `merchant_id`, `salon_name`, `address`, `description`, `image_url`, `commission_rate`) VALUES (1,3,'Vaniday Beauty Studio','Orchard','Hair styling, facials, and beauty treatments.',NULL,'15.00'),(2,4,'FreshGlow Spa','Tampines','Relaxing spa and body treatments.',NULL,'15.00'),(3,5,'Urban Groom Barbers','Woodlands','Haircuts, fades, and grooming services.',NULL,'15.00'),(4,2,'Vaniday Beauty Studio','Singapore','Merchant storefront for product listings.',NULL,'15.00');
...
INSERT INTO `service_slots` (`slot_id`, `service_id`, `timeslot`) VALUES (1,1,'10:00:00'),(2,1,'14:00:00'),(3,1,'17:00:00'),(4,2,'11:00:00'),(5,2,'15:30:00'),(6,2,'18:00:00'),(7,3,'12:00:00'),(8,3,'16:00:00'),(9,3,'18:30:00'),(10,4,'09:30:00'),(11,4,'13:00:00'),(12,4,'18:00:00'),(13,5,'10:30:00'),(14,5,'14:30:00'),(15,5,'17:30:00'),(16,6,'10:00:00'),(17,6,'13:30:00'),(18,6,'19:00:00'),(19,7,'11:00:00'),(20,7,'14:30:00'),(21,7,'17:00:00');
...
INSERT INTO `services` (`service_id`, `salon_id`, `category_id`, `service_name`, `description`, `duration_mins`, `price`, `package_enabled`, `package_sessions`, `package_price`) VALUES (1,1,1,'Hair Cut','Classic haircut and styling consultation.',45,'35.00',0,0,'0.00'),(2,1,2,'Hydrating Facial','Moisturising facial for dry or dull skin.',60,'68.00',0,0,'0.00'),(3,1,3,'Gel Manicure','Long-lasting gel manicure service.',60,'55.00',0,0,'0.00'),(4,2,4,'Aromatherapy Massage','Relaxing full-body aromatherapy massage.',90,'98.00',0,0,'0.00'),(5,2,4,'Body Scrub','Body exfoliation and spa care treatment.',60,'72.00',0,0,'0.00'),(6,3,5,'Classic Haircut','Classic men haircut.',30,'28.00',0,0,'0.00'),(7,3,5,'Skin Fade','Detailed fade haircut.',45,'38.00',0,0,'0.00');
...
INSERT INTO `users` (`user_id`, `google_id`, `name`, `email`, `phone`, `age`, `birthday`, `gender`, `password`, `role`, `glints_balance`, `created_at`, `referral_code`, `referred_by_code`) VALUES (1,NULL,'mary','mary@mary.com','94477346',NULL,NULL,NULL,'$2b$10$V0J24b/4laUlBYcUc.gvve9U.mmAdsgVngrw9VqEgT.vwfCQ5hUQK','customer',80,'2026-04-29 06:37:32','VANI0001',NULL),(2,NULL,'Admin User','admin@vaniday.sg',NULL,NULL,NULL,NULL,'$2b$10$WJyxKoWZ6dIO3aSRCuWMUuqT3nJpCqpbWpqZ8xl2suKy4jx3nRcc6','admin',0,'2026-04-30 06:12:21',NULL,NULL),(3,NULL,'Vaniday Beauty Merchant','beauty@vaniday.sg',NULL,NULL,NULL,NULL,'$2b$10$WJyxKoWZ6dIO3aSRCuWMUuqT3nJpCqpbWpqZ8xl2suKy4jx3nRcc6','merchant',0,'2026-04-30 06:12:21',NULL,NULL),(4,NULL,'FreshGlow Spa Merchant','spa@vaniday.sg',NULL,NULL,NULL,NULL,'$2b$10$WJyxKoWZ6dIO3aSRCuWMUuqT3nJpCqpbWpqZ8xl2suKy4jx3nRcc6','merchant',0,'2026-04-30 06:12:21',NULL,NULL),(5,NULL,'Urban Groom Merchant','barber@vaniday.sg',NULL,NULL,NULL,NULL,'$2b$10$WJyxKoWZ6dIO3aSRCuWMUuqT3nJpCqpbWpqZ8xl2suKy4jx3nRcc6','merchant',0,'2026-04-30 06:12:21',NULL,NULL),(6,NULL,'Angelo Casia','angelomiguelcasia@gmail.com',NULL,NULL,NULL,NULL,'$2b$12$os470VO4oeCLvDNvrZk2nOKpPqA.GpYzdstEMzWJeQ7l1e7nXmeEC','customer',0,'2026-05-02 16:28:33','VANI0006',NULL),(7,NULL,'Raphaela Lee','raphaelalee24@gmail.com','80298963',NULL,NULL,NULL,'$2b$12$L0D9Gmq4LDHRP7OB2Yq6FuHBD2CB5kspGefZrkW68F6/Hljx/SEaG','customer',0,'2026-05-03 12:13:36','VANI0007',NULL);
...
-- Dump completed on 2026-05-14 09:31:17